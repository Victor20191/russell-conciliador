...
export default function LoadingBorradoresModulo() {
  return (
    <div aria-busy="true" aria-label="Cargando borradores del módulo" className="animate-pulse">
      <div className="mb-4 text-[12.5px] font-medium text-ink-500">
        <EstadoProcesando>Cargando borradores del módulo</EstadoProcesando>
      </div>
      <div className="mb-6">
