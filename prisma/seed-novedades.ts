    ...
    changes: [
      {
        ...
        description:
          "Es la primera funcionalidad de IA de la plataforma. Subes el balance de comprobación tal como lo entrega el cliente —Excel (xlsx/xls/xlsb), CSV, JSON o incluso un PDF, hasta 20 MB— y la IA (Claude) lee el archivo, detecta su estructura y extrae las cuentas con sus saldos. Además lee el encabezado: reconoce el NIT, el período y el estándar contable, y con el NIT te PROPONE el cliente al que pertenece. Tú revisas esa vista previa, confirmas o ajustas el cliente y el período, y solo entonces se guarda: nada queda registrado sin tu visto bueno.\n\n" +
